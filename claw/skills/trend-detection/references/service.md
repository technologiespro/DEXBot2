...
1. `market_adapter/price_adapter.js` keeps candles current and emits the per-bot center/state snapshot.
...
- Center snapshot: `market_adapter/state/price_adapter_centers.json`
