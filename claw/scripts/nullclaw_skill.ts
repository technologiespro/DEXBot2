...
const NS_PROJECT_ROOT = path.basename(NS_PARENT_DIR) === BUILD_DIR ? path.dirname(NS_PARENT_DIR) : NS_PARENT_DIR;
...
function printHelp() {
  console.log([
    'Usage:',
    '  tsx scripts/nullclaw_skill.ts [--repo-root PATH] [--profile-root PATH] [--output PATH]',
    '',
