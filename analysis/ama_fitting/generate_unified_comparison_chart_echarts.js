...
function run() {
    console.log('════════════════════════════════════════════════');
    console.log(' Unified Comparison Chart Generator (Synthetic, ECharts)');
    console.log('════════════════════════════════════════════════\n');
    ...
    meta = { pool: null, assetA: { symbol: 'XRP' }, assetB: { symbol: 'BTS' }, intervalSeconds: 14400, fetchedAt: new Date().toISOString() };
    outFile = path.join(__dirname, 'lp_chart_4h_UNIFIED_COMPARISON.echarts.html');
