...
> **Scope:** Full architectural, functional, and operational comparison between the original [DEXBot](https://github.com/Codaone/DEXBot) (Python, v1.0.0) and DEXBot2 (Node.js rewrite). DEXBot2 is on the v0.7.0 release track, with `v0.7.0` as the latest tagged release.
...
|---|---|---|
| **Release Track** | 1.0.0 | v0.7.0 tagged release |
