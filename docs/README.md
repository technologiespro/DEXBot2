...
**Version context:** v0.7.1 is the latest tagged release. This documentation now tracks the released 0.7 line, which includes signal intelligence, strict runtime behavior, credit/debt workflows, and credit maintenance hardening.
