...
Usage:
  node scripts/generate_lp_chart_uplot.js [options]
...
function defaultUplotMarketChartPath(meta) {
...
function generateMarketLpChartUplot(options = {}) {
    ...
    const outFile = options.outFile
        ...
        : defaultUplotMarketChartPath(meta);
...
function run() {
    ...
    return generateMarketLpChartUplot({
        dataFile,
        noOpen,
        outFile,
        logger: console,
